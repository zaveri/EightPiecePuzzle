//
//  UIFont+EightPiecePuzzleAdditions.m
//  EightPiecePuzzle
//
...
@implementation UIFont (EightPiecePuzzleAdditions)
...
{
    return [self fontWithName:@"HelveticaNeue-BoldItalic" size:fontSize];
}


+ (UIFont *)italicCrunchFontOfSize:(CGFloat)fontSize
{
    return [self fontWithName:@"HelveticaNeue-Italic" size:fontSize];
}
