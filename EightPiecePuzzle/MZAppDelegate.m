...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *viewController1 = [[MZFirstViewController alloc] initWithNibName:@"MZFirstViewController" bundle:nil];
    UIViewController *viewController2 = [[MZSecondViewController alloc] initWithNibName:@"MZSecondViewController" bundle:nil];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"EightPiecePuzzle" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"EightPiecePuzzle.sqlite"];
